...
For the regressors, I wanted to use a TimeSeriesSplit because it respects time order as opposed to just performing a random shuffle of the data. I also could have used a split index for training and testing, but I wanted my model to reflect real world forecasting.
